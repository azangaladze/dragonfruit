 ...
 * @return string SCSS.
 */
function theme_dragonfruit_get_pre_scss($theme) {
 ...
 * @return string SCSS.
 */
function theme_dragonfruit_get_main_scss_content($theme) {
    global $CFG;
    ...
    $scss .= file_get_contents($CFG->dirroot.'/theme/dragonfruit/scss/dragonfruit.scss');
 ...
 * @return string SCSS.
 */
function theme_dragonfruit_get_extra_scss($theme) {
    static $boosttheme = null;
    if (empty($boosttheme)) {
        $boosttheme = theme_config::load('boost'); // Needs to be the Boost theme so that we get its settings.
    }
 ...
 */
function theme_dragonfruit_process_css($css, $theme) {
    ...
    $css = theme_dragonfruit_set_customcss($css, $customcss);
 ...
 */
function theme_dragonfruit_set_customcss($css, $customcss) {
